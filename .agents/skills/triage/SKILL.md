...
When the anti-green review was requested, Coverage must also name the failure
classes that are unobserved or only inferred; a green rollup is not sufficient.
