---
description: 'Strong-model operational triage: classify signals and create only bounded weak-agent work'
---
...
`[goal:blocked]` result including coverage and created/operator items.
