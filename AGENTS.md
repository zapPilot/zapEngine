...
Before the first commit or GitHub write in a task, confirm the active GitHub account and local git identity (commits use `i-xtsu-sixyou-ken-mei@users.noreply.github.com`). For a local push, verify the SSH transport identity with:
