...
> **HANDOFF ONLY — DO NOT MERGE THIS PR.**
> This file exists only to give the implementation agent durable execution context. The implementation agent should build the feature on a separate branch/PR, then this handoff PR should be closed without merging.
...
Working tree: GitHub branch `handoff/mobile-podcast-offline-do-not-merge`; this branch should contain only this handoff.
