...
function buildNullableInsertValuesFor<
  T,
  K extends keyof T & string
>(
  records: ReadonlyArray<T>,
  ...
  return buildInsertValuesFor(records, columns, (_column, value) => toNullishSqlValue(value));
}
...
export const PORTFOLIO_ITEM_COLUMNS: ReadonlyArray<keyof PortfolioItemSnapshotInsert> = [
  'wallet',
  'chain',
  'name',
  'name_item',
...
export function buildPortfolioInsertValues(
  ...
  return buildInsertValuesFor(records, PORTFOLIO_ITEM_COLUMNS, (column, value) => {
...
export const HYPERLIQUID_VAULT_APR_COLUMNS: ReadonlyArray<keyof HyperliquidVaultAprSnapshotInsert> = [
  'source',
  'vault_address',
  'vault_name',
  'leader_address',
...
export const TOKEN_PRICE_DMA_COLUMNS: ReadonlyArray<keyof TokenPriceDmaSnapshotInsert> = [
  'token_symbol',
  'token_id',
  'snapshot_date',
  'price_usd',
...
export const TOKEN_PAIR_RATIO_DMA_COLUMNS: ReadonlyArray<keyof TokenPairRatioDmaSnapshotInsert> = [
  'base_token_symbol',
  'base_token_id',
  'quote_token_symbol',
  'quote_token_id',
