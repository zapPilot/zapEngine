import { z } from 'zod';
import { WalletFetchJobMetadataSchema, type WalletFetchJobMetadata, type ETLJob } from '../../types/index.js';
...
function containsWalletAddressValidationError(errors: { path: Array<string | number> }[]): boolean {
