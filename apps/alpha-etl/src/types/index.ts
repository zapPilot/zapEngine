...
export const DATA_SOURCES: readonly DataSource[] = ['defillama', 'debank', 'hyperliquid', 'feargreed', 'token-price'] as const;
...
export type WalletFetchJobMetadata = z.infer<typeof WalletFetchJobMetadataSchema>;
...
export type WebhookPayload = SingleSourceWebhookPayload | MultiSourceWebhookPayload;
