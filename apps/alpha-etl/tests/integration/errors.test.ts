...
import { DatabaseError, ValidationError, APIError } from '../../src/utils/errors.js';
...
describe('Error Handling Middleware', () => {
    ...
    describe('Global Error Handler', () => {
        ...
        it('should handle custom APIError', async () => {
            ...
            testApp.get('/err-api', (_req: Request, _res: Response, next: NextFunction) => {
        ...
        it('should handle ValidationError', async () => {
            const { errorHandler } = await import('../../src/middleware/errorHandler.js');
            testApp.get('/err-validation', (_req: Request, _res: Response, next: NextFunction) => {
        ...
        it('should handle ZodError', async () => {
            ...
            testApp.get('/err-zod', (_req: Request, _res: Response, next: NextFunction) => {
        ...
        it('should handle DatabaseError', async () => {
            const { errorHandler } = await import('../../src/middleware/errorHandler.js');
            testApp.get('/err-db', (_req: Request, _res: Response, next: NextFunction) => {
        ...
        it('should handle unknown generic Errors as INTERNAL_ERROR', async () => {
            const { errorHandler } = await import('../../src/middleware/errorHandler.js');
            testApp.get('/err-generic', (_req: Request, _res: Response, next: NextFunction) => {
