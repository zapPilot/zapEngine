...
import type { DeBankProtocol, DeBankProtocolItem } from '../../../../src/modules/wallet/fetcher.js';
...
describe('DeBankPortfolioTransformer', () => {
  ...
  describe('transformBatch', () => {
    ...
    it('should transform multiple protocols with multiple items', () => {
      const results = transformer.transformBatch(mockProtocols, testWalletAddress);
    ...
    it('should handle protocols with empty portfolio_item_list', () => {
      ...
      const results = transformer.transformBatch(emptyProtocols, testWalletAddress);
    ...
    it('should filter out invalid items', () => {
      ...
      const results = transformer.transformBatch(protocolsWithInvalidItems, testWalletAddress);
    ...
    it('should handle mixed valid and invalid protocols', () => {
      ...
      const results = transformer.transformBatch(mixedProtocols, testWalletAddress);
