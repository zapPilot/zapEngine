...
describe("PoolDataTransformer", () => {
  ...
  describe("Validation Failures", () => {
    ...
    it("should handle malformed input gracefully", () => {
      const malformedInputs = [null, undefined, {}, { random: "field" }];
  ...
  it("should remove duplicate records based on composite key", () => {
    // Test omitted or implemented differently if deduplication logic is added back
  });
  ...
  describe("isValidRecord validation edge cases", () => {
    ...
    beforeEach(() => {
      ...
      if (!validTransformed) {
        throw new Error(
          "Test setup failed: could not create a base valid record.",
        );
      }
