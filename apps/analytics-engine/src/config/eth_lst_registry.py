...
ETH_LST_ASSETS: tuple[EthLstAsset, ...] = (
    # Ethereum mainnet.
    _asset("eth", "0x7f39C581F595B53c5cb19bD0b3f8dA6c935E2Ca0", "wstETH", "benchmark-rate"),
    _asset("eth", "0xBe9895146f7AF43049ca1c1AE358B0541Ea49704", "cbETH", "benchmark-rate"),
    _asset("eth", "0xae78736Cd615f374D3085123A210448E74Fc6393", "rETH", "benchmark-rate"),
    _asset("eth", "0xCd5fE23C85820F7B72D0926FC9b05b43E359b7ee", "weETH", "benchmark-rate"),
    _asset("eth", "0xbf5495Efe5DB9ce00f80364C8B423567e58d2110", "ezETH", "benchmark-rate"),
    _asset("eth", "0xA1290d69c65A6Fe4DF752f95823fae25cb99e5A7", "rsETH", "benchmark-rate"),
    ...
    _asset("eth", "0xae7ab96520DE3A18E5e111B5EaAb095312D7fE84", "stETH", "balance-delta"),
    # Direct canonical wstETH representations on product-supported L2s.
    _asset("arb", "0x5979D7b546E38E414F7E9822514be443A4800529", "wstETH", "benchmark-rate"),
    _asset("base", "0xc1CBa3fCea344f92D9239c08C0568f6F2F0ee452", "wstETH", "benchmark-rate"),
    _asset("op", "0x1F32b1c2345538c0c6f582fCB022739c4A194Ebb", "wstETH", "benchmark-rate"),
)
