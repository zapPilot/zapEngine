...
def build_signal_metadata(
    *,
    ...
    return {
        ...
        "asset_symbol": market_state.asset_symbol,
        "macro_fear_greed_value": market_state.macro_fear_greed_value,
        "macro_fear_greed_regime": market_state.macro_fear_greed_regime,
