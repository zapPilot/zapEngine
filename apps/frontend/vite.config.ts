...
export default defineConfig(({ mode }) => ({
  ...
  test: {
    ...
    env: {
      ...
      NODE_ENV: "test",
      // The Privy provider throws at import time when this is unset. The
      // sharded coverage runner executes files in isolated processes, so this
      // must be a config default rather than relying on cross-file env
      // leakage.
