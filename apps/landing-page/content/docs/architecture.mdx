...
- <ProtocolIcon protocol="ondo" size={16} /> **Tokenized S&P 500** for the
  equity pillar.
- <TokenIconPair symbols={['BTC', 'ETH']} size={14} /> **BTC and ETH** held
  directly, with relative-strength rotation between them.
- <TokenIcon symbol="USDC" size={16} /> **Stablecoins** for the defensive leg,
  optionally parked in conservative yield venues so idle capital still earns a
  baseline.
