...
Zap Pilot is the self-custodial robo-advisor layer between you and the DeFi market. You stay in control of your wallet; Zap Pilot watches the market, prepares moves, and asks you to sign when it's time to act.
...
- <strong>
    <AssetLabel symbol="SPY" label="Tokenized S&P 500" />
  </strong>
  for the equity pillar.
- <strong>
    <AssetPairLabel first="BTC" second="ETH" label="BTC and ETH" />
  </strong>
  held directly, with relative-strength rotation between them.
- <strong>
    <AssetLabel symbol="USDC" label="Stablecoins" />
  </strong>
  for the defensive leg, optionally parked in conservative yield venues so idle
  capital still earns a baseline.
...
- <strong>
    <AssetPairLabel first="ETH" second="BTC" label="In-crypto rotation" />
  </strong>
  — ETH/BTC relative strength to decide which crypto leg leads when crypto risk
  is on.
