...
| Pillar      | Asset                                                                                                    | Venue                                                                                                                         |
| ----------- | -------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Equities    | <ProtocolIcon protocol="ondo" size={16} /> <TokenIcon symbol="USDC" size={16} /> Ondo USDC (OUSG / USDY) | <ChainMark chainKey="ethereum" size={16} labelled /> Ethereum                                                                 |
| Crypto      | <TokenIcon symbol="WBTC" size={16} /> WBTC, <TokenIcon symbol="WETH" size={16} /> WETH                   | <ChainMark chainKey="ethereum" size={16} labelled /> Ethereum / <ChainMark chainKey="arbitrum" size={16} labelled /> Arbitrum |
| Stablecoins | <TokenIcon symbol="USDC" size={16} /> USDC, <TokenIcon symbol="USDT" size={16} /> USDT                   | All supported chains                                                                                                          |
...
| Regime                       | <TokenIcon symbol="SPY" size={16} /> Equities | <TokenIconPair symbols={['BTC', 'ETH']} size={14} /> BTC/ETH | <TokenIcon symbol="USDC" size={16} /> Stablecoins |
| ---------------------------- | --------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------- |
