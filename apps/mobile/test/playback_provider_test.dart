...
void main() {
  ...
  test('playSmart starts the oldest in-progress episode', () async {
    ...
    final newestInProgress = _episode(
      'episode-3',
    ).copyWith(createdAt: DateTime(2026, 5, 3), lastPositionSeconds: 30);
    final oldestInProgress = _episode(
      'episode-1',
    ).copyWith(createdAt: DateTime(2026, 5), lastPositionSeconds: 45);
    final newestUnplayed = _episode(
      'episode-4',
    ).copyWith(createdAt: DateTime(2026, 5, 4));
