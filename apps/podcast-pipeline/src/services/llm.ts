 ...
 * reaches this layer, every configured candidate has already exhausted its
 * long-form deadline, so script generation does not replay the entire chain as
 * an endpoint reroute. Retry-safe non-timeout gateway failures may still get the
