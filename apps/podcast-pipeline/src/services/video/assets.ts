...
// Full-bleed sources fill the current 720x640 media window. Keep the stricter
// historical floors so a later crop/zoom still has headroom and the 720p
// rollout does not silently lower source-image quality.
