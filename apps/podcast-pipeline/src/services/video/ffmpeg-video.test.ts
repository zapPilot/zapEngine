...
function testSlide(index: number, startMs: number, endMs: number) {
...
function createVerticalManifest(): VerticalVideoManifest {
  return {
    ...
    slides: [
      testSlide(0, 0, 4_000),
      testSlide(1, 4_000, 10_000),
      testSlide(2, 10_000, 15_000),
    ],
    captions: [
...
describe('vertical news FFmpeg composition', () => {
  ...
  it('asks ffmpeg for machine-readable progress on every render pass', () => {
    ...
    for (const args of verticalArgs) {
