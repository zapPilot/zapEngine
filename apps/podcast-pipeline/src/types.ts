...
export interface SocialPostMetricCounters {
  views: number | null;
...
export interface SocialPostMetricRow extends SocialPostMetricCounters {
  id: string;
...
export interface NewSocialPostMetric extends SocialPostMetricCounters {
  socialPostId: string;
  capturedAt: string;
  ageHours: number;
