import { ASSET_COLORS } from '@core/constants/assets';
import type { LandingPageResponse } from '@core/services';
import type { AllocationConstituent } from '@core/types/portfolio';
