...
/**
 * Minimal router surface this hook uses. The frontend passes its full
 * `useAppRouter()` result (structurally compatible); the desktop app can pass
 * any object exposing `replace`.
 */
