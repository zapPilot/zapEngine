...
import { calculateAllocation } from '@core/adapters/portfolio/allocationAdapter';
import {
  getRegimeStrategyInfo,
  getTargetAllocation,
} from '@core/adapters/portfolio/regimeAdapter';
import { processSentimentData } from '@core/adapters/portfolio/sentimentAdapter';
import { extractROIChanges } from '@core/lib/portfolio/portfolioUtils';
import type {
  LandingPageResponse,
  MarketSentimentData,
  RegimeHistoryData,
...
import type {
  ...
  SentimentData,
  StrategyData,
} from '@core/types/portfolioProgressive';
