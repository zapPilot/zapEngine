...
const walletHistoryEventSchema = z.looseObject({
  ...
  from_address_entity: z.string().nullish(),
  to_address_entity: z.string().nullish(),
  possible_spam: z.union([z.boolean(), z.string(), z.number()]).nullish(),
  transaction_fee: stringOrNumberSchema,
