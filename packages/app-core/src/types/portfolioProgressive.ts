import type { WalletPortfolioDataWithDirection } from '@core/adapters/walletPortfolioDataAdapter';
import type { RegimeId } from '@core/regime/regimeData';
import type { MarketSentimentData, RegimeHistoryData } from '@core/services';
