...
/**
 * @typedef {object} BackendJestConfigOptions
...
/**
 * Create a shared ESLint flat config for backend TypeScript workspaces using Jest.
 *
 * @param {BackendJestConfigOptions} options
 * @returns {import('typescript-eslint').ConfigArray}
 */
export function createBackendJestConfig(options) {
  const {
    tsconfigRootDir,
    ignores = [
      'eslint.config.mjs',
  ...
  if (!tsconfigRootDir) {
    throw new Error('createBackendJestConfig requires tsconfigRootDir');
  }
