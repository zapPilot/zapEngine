...
export const BacktestStrategySummarySchema = z.object({
  ...
  cvar_95: z.number().optional(),
  ulcer_index: z.number().optional(),
  alpha: z.number().optional(),
  information_ratio: z.number().optional(),
  omega_ratio: z.number().optional(),
  tail_ratio: z.number().optional(),
  skewness: z.number().optional(),
  excess_kurtosis: z.number().optional(),
  pain_index: z.number().optional(),
  max_drawdown_recovery_days: z.number().optional(),
